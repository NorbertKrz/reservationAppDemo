...
class InteractiveSquareTable extends StatefulWidget {
  final Function callback;
  final GlobalKey parentKey;
  final int maxPeople;
  const InteractiveSquareTable(
      {super.key,
  ...
  @override
  State<InteractiveSquareTable> createState() => _InteractiveSquareTableState();
}

class _InteractiveSquareTableState extends State<InteractiveSquareTable> {
