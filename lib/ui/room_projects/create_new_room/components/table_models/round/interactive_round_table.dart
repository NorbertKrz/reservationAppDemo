...
class InteractiveRoundTable extends StatefulWidget {
  final Function callback;
  final GlobalKey parentKey;
  final int maxPeople;
  const InteractiveRoundTable(
      {super.key,
  ...
  @override
  State<InteractiveRoundTable> createState() => _InteractiveRoundTableState();
}

class _InteractiveRoundTableState extends State<InteractiveRoundTable> {
