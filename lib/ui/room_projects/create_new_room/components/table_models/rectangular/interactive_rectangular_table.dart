...
import 'rectangular_table.dart';

class InteractiveRectangularTable extends StatefulWidget {
  final Function callback;
  final GlobalKey parentKey;
  final int maxPeople;
  final bool chairsAtEndsOn;
  const InteractiveRectangularTable({
    super.key,
  ...
  @override
  State<InteractiveRectangularTable> createState() =>
      _InteractiveRectangularTableState();
}

class _InteractiveRectangularTableState
    extends State<InteractiveRectangularTable> {
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Positioned(
                        left: tableNormalizedPosition.dx - tableSize,
