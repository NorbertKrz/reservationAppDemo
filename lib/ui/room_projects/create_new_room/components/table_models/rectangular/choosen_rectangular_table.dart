...
class ChoosenRectangularTable extends StatefulWidget {
  ...
  @override
  State<ChoosenRectangularTable> createState() =>
      _ChoosenRectangularTableState();
}

class _ChoosenRectangularTableState extends State<ChoosenRectangularTable> {
