...
class DetailedPreviewRectangularTable extends StatefulWidget {
  final DocumentReference organizationReference;
  final TableDetailedData tableDetailedData;
  const DetailedPreviewRectangularTable({
    super.key,
  ...
  @override
  State<DetailedPreviewRectangularTable> createState() =>
      _DetailedPreviewRectangularTableState();
}

class _DetailedPreviewRectangularTableState
    extends State<DetailedPreviewRectangularTable> {
